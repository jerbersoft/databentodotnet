...
/// <summary>
/// A fixed 22-byte NUL-padded C-string field: every symbol field in DBN v1 —
/// <c>raw_symbol</c> and the two <c>SymbolMappingMsg</c> symbols (71 bytes from v2 on).
/// </summary>
/// <remarks>
