...
/// <summary>
/// A fixed 71-byte NUL-padded C-string field: every symbol field from DBN v2 on —
/// <c>raw_symbol</c>, <c>leg_raw_symbol</c> and the two <c>SymbolMappingMsg</c> symbols (22 bytes
/// in v1).
/// </summary>
/// <remarks>
