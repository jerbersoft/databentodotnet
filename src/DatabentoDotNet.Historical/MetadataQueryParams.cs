...
/// <c>MetadataClient.GetCostAsync</c> and then sends a <em>different</em> request has been badly
/// served by the API surface, and a shared type is what makes sending the same one the path of
/// least resistance. #38 uses this type for <c>timeseries.get_range</c>.
/// </para>
/// <para>
