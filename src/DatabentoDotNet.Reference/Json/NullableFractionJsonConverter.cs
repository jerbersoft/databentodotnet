...
/// <see cref="FractionJsonConverter"/>. The model field this exists for is
/// <see cref="CorporateAction.Fraction"/>, declared <c>Fraction?</c> with
/// <c>[JsonConverter(typeof(NullableFractionJsonConverter))]</c> on the property. <b>The source
...
/// <see cref="FractionJsonConverter"/> were reached instead.
/// </para>
/// </remarks>
